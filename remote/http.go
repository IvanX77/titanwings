...
import (
	...
	"github.com/titanwings/wings/internal/models"
...
func (c *client) requestOnce(ctx context.Context, method, path string, body io.Reader, opts ...func(r *http.Request)) (*Response, error) {
	...
	req.Header.Set("User-Agent", fmt.Sprintf("Titan Wings Wings/v%s (id:%s)", system.Version, c.tokenId))
	req.Header.Set("Accept", "application/vnd.titanwings.v1+json")
